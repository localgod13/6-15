        ...
        playersList.innerHTML = players.map(player => `
            <li class="player-item">
                <div class="player-info">
                    <img src="${shipUrls[player.shipType]}" alt="${player.shipType}" class="player-ship">
    ...
    network.onPlayersUpdate((players) => {
        ...
        if (playerList) {
            playerList.innerHTML = players.map(p => `
                <li class="player-item">
                    <div class="player-info">
                        <img src="${p.shipType === 'ship1' ? ship1 : p.shipType === 'ship2' ? ship2 : ship3}" alt="${p.shipType}" class="player-ship">
